...
describe('Friendship Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call AppUser query and add missing value', () => {
      ...
      const appUserOwner: IAppUser = { id: 87140 };
      friendship.appUserOwner = appUserOwner;
      const appUserReceiver: IAppUser = { id: 69504 };
      friendship.appUserReceiver = appUserReceiver;

      const appUserCollection: IAppUser[] = [{ id: 79501 }];
      jest.spyOn(appUserService, 'query').mockReturnValue(of(new HttpResponse({ body: appUserCollection })));
      const additionalAppUsers = [appUserOwner, appUserReceiver];
    ...
    it('Should update editForm', () => {
      const friendship: IFriendship = { id: 456 };
      const appUserOwner: IAppUser = { id: 66539 };
      friendship.appUserOwner = appUserOwner;
      const appUserReceiver: IAppUser = { id: 21681 };
      friendship.appUserReceiver = appUserReceiver;

      activatedRoute.data = of({ friendship });
      comp.ngOnInit();

      expect(comp.appUsersSharedCollection).toContain(appUserOwner);
      expect(comp.appUsersSharedCollection).toContain(appUserReceiver);
